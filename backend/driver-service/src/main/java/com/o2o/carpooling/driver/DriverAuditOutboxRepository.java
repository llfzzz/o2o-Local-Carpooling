...
@Repository
class DriverAuditOutboxRepository {

    private final JdbcClient jdbcClient;

    DriverAuditOutboxRepository(JdbcClient jdbcClient) {
    ...
    void enqueue(String auditId, String actorId, String action, String targetType, String targetId, String metadataJson, Instant now) {
        jdbcClient.sql("""
            insert into driver_audit_outbox (
    ...
    private DriverAuditOutboxEntry mapRow(ResultSet resultSet, int rowNumber) throws SQLException {
        return new DriverAuditOutboxEntry(
