...
/**
 * Internal notify API used service-to-service (order, identity, driver, …) via Feign. It is NOT
 * exposed through the Gateway, so end users cannot inject notifications for arbitrary recipients.
 */
@RestController
