...
@Repository
class FileAuditOutboxRepository {

    private final JdbcClient jdbcClient;

    FileAuditOutboxRepository(JdbcClient jdbcClient) {
    ...
    List<FileAuditOutboxEntry> findSendable(Instant now, int limit) {
    ...
    private FileAuditOutboxEntry mapRow(ResultSet resultSet, int rowNumber) throws SQLException {
        return new FileAuditOutboxEntry(
