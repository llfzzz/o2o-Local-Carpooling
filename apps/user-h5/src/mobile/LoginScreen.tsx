...
/** A1 · 登录 — hero copy + phone/code. In demo mode the code can be peeked here (and only
 *  here) via the challenge minted by the send request; it never enters the message center. */
